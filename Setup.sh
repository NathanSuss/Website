...
docker build --build-arg USER_ID=$(id -u) --build-arg GROUP_ID=$(id -g) -t vue-helper - < ./dockerfiles/Setup.Dockerfile

docker run -v ~/Website/:/vue-setup -m 3g -it vue-helper
