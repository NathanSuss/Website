...
export class Mat4 {
  ...
  public determinant(): number {
    ...
    return (
      det00 * det11 - det01 * det10 + det02 * det09 + det03 * det08 - det04 * det07 + det05 * det06
    )
  }
  ...
  public translate(vector: Vec3, dest?: Mat4): Mat4 {
    ...
    dest.values[12] = this.values[0] * x + this.values[4] * y + this.values[8] * z + this.values[12]
    dest.values[13] = this.values[1] * x + this.values[5] * y + this.values[9] * z + this.values[13]
    dest.values[14] =
      this.values[2] * x + this.values[6] * y + this.values[10] * z + this.values[14]
    dest.values[15] =
